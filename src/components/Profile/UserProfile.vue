        ...
        <div class="row" id="user-profile">
          <div class="col-lg-3 col-md-4 col-sm-4">
            <div class="main-box clearfix">
              ...
              <div class="profile-status"><i class="fa fa-check-circle"></i> Online</div>
              <img
                :src="user.data.img"
                alt=""
          ...
          <div class="col-lg-9 col-md-8 col-sm-8">
            <div class="main-box clearfix">
              <div class="profile-header">
                ...
                <router-link to="/edit" class="btn btn-primary edit-profile" v-if="this.$store.getters.userId == $route.params.id">
              ...
              <div class="tabs-wrapper profile-tabs">
                <ul class="nav nav-tabs">
                  <li class="active">
                    <a href="#tab-activity" data-toggle="tab">Активность</a>
                  </li>
                  <li><a href="#tab-friends" data-toggle="tab">Друзья</a></li>
                  <li><a href="#tab-chat" data-toggle="tab">Чат</a></li>
                </ul>
    ...
    axiosData() {
      axios
        ...
        .then((res) => {
          ...
          console.log(this.$store.getters.userId, this.$route.params.id);
        })
        .catch((err) => {
          console.log(err);
        });
